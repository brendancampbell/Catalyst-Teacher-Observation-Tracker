...
async function migrate() {
  ...
  try {
    ...
    /* Steps 14-15 (add is_home_office column, seed the Home Office pseudo-school)
       were removed: migration 0000 creates the column, and schools — including
       Home Office — are now managed exclusively through the admin UI. Numbering
       is left unchanged so the remaining step numbers stay stable. */
