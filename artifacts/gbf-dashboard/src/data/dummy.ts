...
export const TEACHERS: Teacher[] = [
  { id: "t1",  name: "Sarah Johnson",    department: "English",    gradeLevel: "6–8",  observations: [
  ...
  { id: "t2",  name: "Marcus Williams",  department: "Math",       gradeLevel: "9–12", observations: [
  ...
  { id: "t3",  name: "Priya Patel",      department: "Science",    gradeLevel: "6–8",  observations: [
  ...
  { id: "t4",  name: "David Chen",       department: "History",    gradeLevel: "9–12", observations: [
  ...
  { id: "t5",  name: "Amanda Torres",    department: "English",    gradeLevel: "3–5",  observations: [
  ...
  { id: "t6",  name: "James Mitchell",   department: "Math",       gradeLevel: "6–8",  observations: [
  ...
  { id: "t7",  name: "Linda Roberts",    department: "Science",    gradeLevel: "3–5",  observations: [
  ...
  { id: "t8",  name: "Kevin Nguyen",     department: "PE",         gradeLevel: "K–2",  observations: [
  ...
  { id: "t9",  name: "Olivia Brown",     department: "Art",        gradeLevel: "K–2",  observations: [
  ...
  { id: "t10", name: "Thomas Garcia",    department: "History",    gradeLevel: "9–12", observations: [
  ...
  { id: "t11", name: "Rachel Kim",       department: "English",    gradeLevel: "6–8",  observations: [
  ...
  { id: "t12", name: "Brian Foster",     department: "Math",       gradeLevel: "3–5",  observations: [
  ...
  { id: "t13", name: "Monica Alvarez",   department: "Science",    gradeLevel: "9–12", observations: [
  ...
  { id: "t14", name: "Derek Thompson",   department: "History",    gradeLevel: "6–8",  observations: [
  ...
  { id: "t15", name: "Stephanie Lee",    department: "Music",      gradeLevel: "K–2",  observations: [
  ...
  { id: "t16", name: "Carlos Reyes",     department: "PE",         gradeLevel: "9–12", observations: [
  ...
  { id: "t17", name: "Nicole Harris",    department: "Special Ed", gradeLevel: "3–5",  observations: [
  ...
  { id: "t18", name: "Paul Wright",      department: "Math",       gradeLevel: "9–12", observations: [
  ...
  { id: "t19", name: "Julia Morgan",     department: "English",    gradeLevel: "K–2",  observations: [
  ...
  { id: "t20", name: "Anthony Clark",    department: "Art",        gradeLevel: "6–8",  observations: [
