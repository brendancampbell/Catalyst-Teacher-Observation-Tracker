...
export const TEACHERS: Teacher[] = [
  { id: "t1",  name: "Sarah Johnson",    subject: "English",    gradeLevel: ["6"],           observations: [
  ...
  { id: "t2",  name: "Marcus Williams",  subject: "Math",       gradeLevel: ["9","10"],      observations: [
  ...
  { id: "t3",  name: "Priya Patel",      subject: "Science",    gradeLevel: ["7"],           observations: [
  ...
  { id: "t4",  name: "David Chen",       subject: "History",    gradeLevel: ["10"],          observations: [
  ...
  { id: "t5",  name: "Amanda Torres",    subject: "English",    gradeLevel: ["5"],           observations: [
  ...
  { id: "t6",  name: "James Mitchell",   subject: "Math",       gradeLevel: ["6","7"],       observations: [
  ...
  { id: "t7",  name: "Linda Roberts",    subject: "Science",    gradeLevel: ["4"],           observations: [
  ...
  { id: "t8",  name: "Kevin Nguyen",     subject: "PE",         gradeLevel: ["K","1","2"],   observations: [
  ...
  { id: "t9",  name: "Olivia Brown",     subject: "Art",        gradeLevel: ["K","1","2"],   observations: [
  ...
  { id: "t10", name: "Thomas Garcia",    subject: "History",    gradeLevel: ["11"],          observations: [
  ...
  { id: "t11", name: "Rachel Kim",       subject: "English",    gradeLevel: ["8"],           observations: [
  ...
  { id: "t12", name: "Brian Foster",     subject: "Math",       gradeLevel: ["3","4"],       observations: [
  ...
  { id: "t13", name: "Monica Alvarez",   subject: "Science",    gradeLevel: ["11","12"],     observations: [
  ...
  { id: "t14", name: "Derek Thompson",   subject: "History",    gradeLevel: ["8"],           observations: [
  ...
  { id: "t15", name: "Stephanie Lee",    subject: "Music",      gradeLevel: ["K","1","2"],   observations: [
  ...
  { id: "t16", name: "Carlos Reyes",     subject: "PE",         gradeLevel: ["9","10","11","12"], observations: [
  ...
  { id: "t17", name: "Nicole Harris",    subject: "Special Ed", gradeLevel: ["3","4","5"],   observations: [
  ...
  { id: "t18", name: "Paul Wright",      subject: "Math",       gradeLevel: ["12"],          observations: [
  ...
  { id: "t19", name: "Julia Morgan",     subject: "English",    gradeLevel: ["1"],           observations: [
  ...
  { id: "t20", name: "Anthony Clark",    subject: "Art",        gradeLevel: ["6","7","8"],   observations: [
