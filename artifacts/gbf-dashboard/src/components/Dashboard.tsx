...
export default function Dashboard() {
  ...
  /* ── School-wide average (used in domain average footer row) ── */
  ...
  return (
    ...
    <div className="h-full flex flex-col" style={{ backgroundColor: "#F4F6FB", fontFamily: "'Libre Franklin', sans-serif" }}>
      ...
      <main className="px-3 sm:px-5 py-3 sm:py-4 flex flex-col gap-3 flex-1 min-h-0">
        ...
        <footer className="text-center pt-1 pb-2 shrink-0" style={{ borderTop: "1px solid #dde3f0", color: "#94a3b8", fontSize: 12, fontFamily: "'Libre Franklin', sans-serif" }}>
