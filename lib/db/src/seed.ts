...
async function seed() {
  ...
  const TEACHERS: Array<{
    ...
    { name: "Sarah Johnson",   subject: "English",    gradeLevel: "6–8",  observations: [
    ...
    { name: "Marcus Williams", subject: "Math",       gradeLevel: "9–12",  observations: [
    ...
    { name: "Priya Patel",     subject: "Science",    gradeLevel: "6–8",  observations: [
    ...
    { name: "David Chen",      subject: "History",    gradeLevel: "9–12",  observations: [
    ...
    { name: "Amanda Torres",   subject: "English",    gradeLevel: "3–5",  observations: [
    ...
    { name: "James Mitchell",  subject: "Math",       gradeLevel: "6–8",  observations: [
    ...
    { name: "Linda Roberts",   subject: "Science",    gradeLevel: "3–5",  observations: [
    ...
    { name: "Kevin Nguyen",    subject: "PE",         gradeLevel: "K–2",  observations: [
    ...
    { name: "Olivia Brown",    subject: "Art",        gradeLevel: "K–2",  observations: [
    ...
    { name: "Thomas Garcia",   subject: "History",    gradeLevel: "9–12", observations: [
    ...
    { name: "Rachel Kim",      subject: "English",    gradeLevel: "6–8",  observations: [
    ...
    { name: "Brian Foster",    subject: "Math",       gradeLevel: "3–5",  observations: [
    ...
    { name: "Monica Alvarez",  subject: "Science",    gradeLevel: "9–12", observations: [
    ...
    { name: "Derek Thompson",  subject: "History",    gradeLevel: "6–8",  observations: [
    ...
    { name: "Stephanie Lee",   subject: "Music",      gradeLevel: "K–2",  observations: [
    ...
    { name: "Carlos Reyes",    subject: "PE",         gradeLevel: "9–12", observations: [
    ...
    { name: "Nicole Harris",   subject: "Special Ed", gradeLevel: "3–5",  observations: [
    ...
    { name: "Paul Wright",     subject: "Math",       gradeLevel: "9–12", observations: [
    ...
    { name: "Julia Morgan",    subject: "English",    gradeLevel: "K–2",  observations: [
    ...
    { name: "Anthony Clark",   subject: "Art",        gradeLevel: "6–8",  observations: [
