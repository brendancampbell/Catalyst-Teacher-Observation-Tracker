...
async function seed() {
  ...
  const TEACHERS: Array<{
    name: string; department: string; gradeLevel: string; yearsExperience: number;
    observations: ObsInput[];
  }> = [
    { name: "Sarah Johnson",   department: "English",    gradeLevel: "6–8",  yearsExperience: 4,  observations: [
    ...
    { name: "Marcus Williams", department: "Math",       gradeLevel: "9–12", yearsExperience: 1,  observations: [
    ...
    { name: "Priya Patel",     department: "Science",    gradeLevel: "6–8",  yearsExperience: 11, observations: [
    ...
    { name: "David Chen",      department: "History",    gradeLevel: "9–12", yearsExperience: 7,  observations: [
    ...
    { name: "Amanda Torres",   department: "English",    gradeLevel: "3–5",  yearsExperience: 2,  observations: [
    ...
    { name: "James Mitchell",  department: "Math",       gradeLevel: "6–8",  yearsExperience: 14, observations: [
    ...
    { name: "Linda Roberts",   department: "Science",    gradeLevel: "3–5",  yearsExperience: 6,  observations: [
    ...
    { name: "Kevin Nguyen",    department: "PE",         gradeLevel: "K–2",  yearsExperience: 3,  observations: [
    ...
    { name: "Olivia Brown",    department: "Art",        gradeLevel: "K–2",  yearsExperience: 1,  observations: [
    ...
    { name: "Thomas Garcia",   department: "History",    gradeLevel: "9–12", yearsExperience: 18, observations: [
    ...
    { name: "Rachel Kim",      department: "English",    gradeLevel: "6–8",  yearsExperience: 5,  observations: [
    ...
    { name: "Brian Foster",    department: "Math",       gradeLevel: "3–5",  yearsExperience: 9,  observations: [
    ...
    { name: "Monica Alvarez",  department: "Science",    gradeLevel: "9–12", yearsExperience: 12, observations: [
    ...
    { name: "Derek Thompson",  department: "History",    gradeLevel: "6–8",  yearsExperience: 2,  observations: [
    ...
    { name: "Stephanie Lee",   department: "Music",      gradeLevel: "K–2",  yearsExperience: 8,  observations: [
    ...
    { name: "Carlos Reyes",    department: "PE",         gradeLevel: "9–12", yearsExperience: 15, observations: [
    ...
    { name: "Nicole Harris",   department: "Special Ed", gradeLevel: "3–5",  yearsExperience: 3,  observations: [
    ...
    { name: "Paul Wright",     department: "Math",       gradeLevel: "9–12", yearsExperience: 20, observations: [
    ...
    { name: "Julia Morgan",    department: "English",    gradeLevel: "K–2",  yearsExperience: 1,  observations: [
    ...
    { name: "Anthony Clark",   department: "Art",        gradeLevel: "6–8",  yearsExperience: 4,  observations: [
