...
async function seed() {
  ...
  const TEACHERS: Array<{
    ...
    { name: "Sarah Johnson",   subject: "English",    gradeLevel: ["6"],          observations: [
    ...
    { name: "Marcus Williams", subject: "Math",       gradeLevel: ["9","10"],     observations: [
    ...
    { name: "Priya Patel",     subject: "Science",    gradeLevel: ["7"],          observations: [
    ...
    { name: "David Chen",      subject: "History",    gradeLevel: ["10"],         observations: [
    ...
    { name: "Amanda Torres",   subject: "English",    gradeLevel: ["5"],          observations: [
    ...
    { name: "James Mitchell",  subject: "Math",       gradeLevel: ["6","7"],      observations: [
    ...
    { name: "Linda Roberts",   subject: "Science",    gradeLevel: ["4"],          observations: [
    ...
    { name: "Kevin Nguyen",    subject: "PE",         gradeLevel: ["K","1","2"],  observations: [
    ...
    { name: "Olivia Brown",    subject: "Art",        gradeLevel: ["K","1","2"],  observations: [
    ...
    { name: "Thomas Garcia",   subject: "History",    gradeLevel: ["11"],         observations: [
    ...
    { name: "Rachel Kim",      subject: "English",    gradeLevel: ["8"],          observations: [
    ...
    { name: "Brian Foster",    subject: "Math",       gradeLevel: ["3","4"],      observations: [
    ...
    { name: "Monica Alvarez",  subject: "Science",    gradeLevel: ["11","12"],    observations: [
    ...
    { name: "Derek Thompson",  subject: "History",    gradeLevel: ["8"],          observations: [
    ...
    { name: "Stephanie Lee",   subject: "Music",      gradeLevel: ["K","1","2"],  observations: [
    ...
    { name: "Carlos Reyes",    subject: "PE",         gradeLevel: ["9","10","11","12"], observations: [
    ...
    { name: "Nicole Harris",   subject: "Special Ed", gradeLevel: ["3","4","5"],  observations: [
    ...
    { name: "Paul Wright",     subject: "Math",       gradeLevel: ["12"],         observations: [
    ...
    { name: "Julia Morgan",    subject: "English",    gradeLevel: ["1"],          observations: [
    ...
    { name: "Anthony Clark",   subject: "Art",        gradeLevel: ["6","7","8"],  observations: [
